...
if(isset($_POST['email'])) {
	...
	// You can change "A message from Foundry Template Form" to your own subject if you want.
	$message = Swift_Message::newInstance('A message from Foundry Template Form')
